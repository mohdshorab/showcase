...
const WorkCard: React.FC<WorkCardProps> = ({ project }) => {
  return (
    <div
      className="group flex flex-col glass-card px-4 py-6 gap-4 
      backdrop-blur-md relative overflow-hidden 
    hover:border-glass-border-green 
    ...
    >
      ...
      {/* Description */}
      <p className="text-xl text-text-secondary font-medium tracking-tight leading-tight">
        {project?.description}
      </p>
      {/* metrics */}
